/**
 * Cloud Function: passTurn
 *
 * Validates the request, reads current game state from Firestore,
 * runs GameEngine.passTurn(), and writes the result back.
 *
 * Request: { matchId, playerId }
 * Response: { success: true, event: "none" | "roundPassed" }
 */
...
/**
 * Handler for the passTurn callable function.
