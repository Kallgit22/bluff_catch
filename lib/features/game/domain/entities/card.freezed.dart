...
as Suit,rank: null == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
as Rank,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Suit suit,  Rank rank)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlayingCard() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Suit suit,  Rank rank)  $default,) {final _that = this;
switch (_that) {
case _PlayingCard():
return $default(_that.suit,_that.rank);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Suit suit,  Rank rank)?  $default,) {final _that = this;
switch (_that) {
case _PlayingCard() when $default != null:
return $default(_that.suit,_that.rank);case _:
  return null;
...
class _PlayingCard implements PlayingCard {
  const _PlayingCard({required this.suit, required this.rank});
